...
async def get_comparison_table():
    ...
    try:
        ...
        if data_manager.coverage_premiums_df is None or data_manager.coverage_premiums_df.empty:
            raise HTTPException(
                status_code=400,
        ...
        return {
            ...
            "comparison_table": _clean_for_json_serialization(comparison_table.to_dict()),
            "raw_aggregated_data": _clean_for_json_serialization(aggregated_df.to_dict())
        }
